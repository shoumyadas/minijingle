...
//                                    }
    ...
    private String createTransmitter() {
        ...
        for (int i = 0; i < pbss.length; i++) {
            try {
                ...
                System.out.println("Created RTP session at " + localPort + " to: " + remoteIpAddress + " " + port);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            AudioChannel audioChannel0 = new AudioChannel(new MediaLocator("javasound://44100"), "192.168.1.39", "192.168.1.39", 7002, 7020, new AudioFormat(AudioFormat.ULAW_RTP));
            AudioChannel audioChannel1 = new AudioChannel(new MediaLocator("javasound://44100"), "192.168.1.39", "192.168.1.39", 7020, 7002, new AudioFormat(AudioFormat.ULAW_RTP));
...
//            audioChannel1.setTrasmit(false);
        ...
        try {
            ...
            AudioChannel audioChannel0 = new AudioChannel(new MediaLocator("javasound://44100"), localhost.getHostAddress(), localhost.getHostAddress(), 7002, 7020, new AudioFormat(AudioFormat.ULAW_RTP));
            AudioChannel audioChannel1 = new AudioChannel(new MediaLocator("javasound://44100"), localhost.getHostAddress(), localhost.getHostAddress(), 7020, 7002, new AudioFormat(AudioFormat.ULAW_RTP));
